...
> **Using this extension?** [⭐ Star the repo](https://github.com/toris-tree/vscode-exact-file-preview) or [share which file type you're previewing](https://github.com/toris-tree/vscode-exact-file-preview/issues/new?labels=feedback&title=Feedback%3A+what+I+use+this+for&body=I+use+Exact+File+Preview+for%3A%0A%0A(describe+your+workflow+or+file+type+here)) — it helps others find this extension.
